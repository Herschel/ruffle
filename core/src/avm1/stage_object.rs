...
fn set_x<'gc>(
    ...
    this.set_x(context.gc_context, val as f32);
    Ok(())
}
...
fn set_y<'gc>(
    ...
    let val = val.as_number(avm, context)?;
    this.set_y(context.gc_context, val as f32);
    Ok(())
}
...
fn set_x_scale<'gc>(
    ...
    this.set_scale_x(context.gc_context, val as f32);
    Ok(())
}
...
fn set_y_scale<'gc>(
    ...
    let val = val.as_number(avm, context)? / 100.0;
    this.set_scale_y(context.gc_context, val as f32);
    Ok(())
}
...
fn set_alpha<'gc>(
    ...
    let val = val.as_number(avm, context)? / 100.0;
    this.set_alpha(context.gc_context, val as f32);
    Ok(())
}
...
fn rotation<'gc>(
    ...
    Ok(this.rotation(context.gc_context).into())
}
...
fn set_rotation<'gc>(
    ...
    let val = val.as_number(avm, context)?;
    this.set_rotation(context.gc_context, val as f32);
    Ok(())
}
